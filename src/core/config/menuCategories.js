...
export const getMenuCategories = () => [
    ...
    },
    {
        ...
        tools: [
            ...
            { id: 'corner', name: 'Wall Corners & Curve' },
            { isDivider: true, name: 'Foundations & Plinths' },
    ...
    },
    {
        ...
        tools: [
            { isDivider: true, name: 'Platforms & Stages' },
    ...
    },
    {
        ...
        tools: [
            ...
            { id: 'roof', name: 'Roofs' },
            { id: 'roof_box', name: 'Roof (Box / Drag)', presetParams: { drawMode: 'box' } },
            { id: 'roof_polygon', name: 'Roof (Polyline Drawer)', presetParams: { drawMode: 'polygon' } },
