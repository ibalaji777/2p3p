...
const doorCatalog = ref([
    { id: 'single', name: 'Single Hinged Door', badge: 'WOOD', material: 'Solid Teak Wood', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'wood', doorMat: 'wood_golden_teak' } },
    { id: 'french', name: 'Double French Door', badge: 'GLASS', material: 'Glass & Solid Oak', specs: '1800 × 2100 mm', category: 'double', image: '', params: { doorType: 'french', doorStyle: 'glass_grid', width: 80, materialCategory: 'wood', doorMat: 'wood_golden_teak', glassMat: 'clear' } },
    { id: 'sliding', name: 'Sliding Glass Door', badge: 'GLASS', material: 'Aluminium & Glass', specs: '1800 × 2100 mm', category: 'glass', image: '', params: { doorType: 'sliding', doorStyle: 'glass_bottom_panel', width: 80, materialCategory: 'aluminium', doorMat: 'alum_silver', glassMat: 'clear' } },
    { id: 'pocket', name: 'Pocket Door', badge: 'COMPACT', material: 'Natural Teak', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'pocket', doorStyle: 'flat', width: 40, materialCategory: 'wood', doorMat: 'wood_golden_teak' } },
    { id: 'classic_4', name: 'Classic 4-Panel Door', badge: 'WOOD', material: 'White American Oak', specs: '900 × 2100 mm', category: 'wood', image: '', params: { doorType: 'single', doorStyle: 'classic_4_panel', width: 40, materialCategory: 'wood', doorMat: 'wood_white_oak' } },
    { id: 'modern_flush', name: 'Modern Flush Door', badge: 'WOOD', material: 'American Walnut', specs: '900 × 2100 mm', category: 'wood', image: '', params: { doorType: 'single', doorStyle: 'modern_flush', width: 40, materialCategory: 'wood', doorMat: 'wood_dark_walnut' } },
    { id: 'door_wpc', name: 'WPC Door', badge: 'WPC', material: 'Wood Plastic Composite', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'wpc', doorMat: 'wood_golden_teak' } },
    { id: 'door_upvc', name: 'uPVC Door', badge: 'uPVC', material: 'Rigid uPVC', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'upvc', doorMat: 'upvc_white' } },
    { id: 'door_pvc', name: 'PVC Door', badge: 'PVC', material: 'Matte White PVC', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'pvc', doorMat: 'upvc_white' } },
    { id: 'door_aluminium', name: 'Aluminium Door', badge: 'ALUMINIUM', material: 'Silver Aluminium', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'aluminium', doorMat: 'alum_silver' } },
    { id: 'door_steel', name: 'Steel Door', badge: 'STEEL', material: 'Brushed Steel', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'steel', doorMat: 'steel_ms' } },
    { id: 'door_glass', name: 'Frameless Glass Door', badge: 'GLASS', material: 'Tempered Glass', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'glass', doorMat: 'glass_clear' } },
    { id: 'door_frp', name: 'FRP Door', badge: 'FRP', material: 'Fiber Reinforced Plastic', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'frp', doorMat: 'upvc_white' } },
    { id: 'door_composite', name: 'Composite Door', badge: 'COMPOSITE', material: 'Composite Panel', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'composite', doorMat: 'alum_black' } },
]);

const windowCatalog = ref([
    { id: 'sliding_std', name: 'Standard Sliding', badge: 'POPULAR', material: 'Aluminium Frame', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'aluminium', frameMat: 'alum_silver', glassMat: 'clear' } },
    { id: 'casement_std', name: 'Casement Window', badge: 'CLASSIC', material: 'White Vinyl', specs: '900 × 1200 mm', category: 'casement', image: '', params: { windowType: 'casement_std', width: 40, materialCategory: 'upvc', frameMat: 'upvc_white', glassMat: 'clear' } },
    { id: 'fixed_elevation', name: 'Fixed Picture Window', badge: 'MODERN', material: 'Clear Glass', specs: '1800 × 1500 mm', category: 'fixed', image: '', params: { windowType: 'fixed_elevation', width: 80, materialCategory: 'aluminium', frameMat: 'alum_silver', glassMat: 'clear' } },
    { id: 'bay_box', name: 'Bay Window', badge: 'ARCHITECTURAL', material: 'Solid Wood Frame', specs: '1800 × 1500 mm', category: 'bay', image: '', params: { windowType: 'bay_box', width: 80, materialCategory: 'wood', frameMat: 'wood_golden_teak', glassMat: 'clear' } },
    { id: 'panoramic_slider', name: 'Panoramic Slider', badge: 'PREMIUM', material: 'Slim Steel Frame', specs: '2400 × 1800 mm', category: 'sliding', image: '', params: { windowType: 'panoramic_slider', width: 120, materialCategory: 'steel', frameMat: 'steel_ms', glassMat: 'clear' } },
    { id: 'win_wood', name: 'Wood Window', badge: 'WOOD', material: 'Solid Teak Wood', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'wood', frameMat: 'wood_golden_teak', glassMat: 'clear' } },
    { id: 'win_wpc', name: 'WPC Window', badge: 'WPC', material: 'Wood Plastic Composite', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'wpc', frameMat: 'wood_golden_teak', glassMat: 'clear' } },
    { id: 'win_upvc', name: 'uPVC Window', badge: 'uPVC', material: 'Rigid uPVC', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'upvc', frameMat: 'upvc_white', glassMat: 'clear' } },
    { id: 'win_pvc', name: 'PVC Window', badge: 'PVC', material: 'Matte White PVC', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'pvc', frameMat: 'upvc_white', glassMat: 'clear' } },
    { id: 'win_aluminium', name: 'Aluminium Window', badge: 'ALUMINIUM', material: 'Silver Aluminium', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'aluminium', frameMat: 'alum_silver', glassMat: 'clear' } },
    { id: 'win_steel', name: 'Steel Window', badge: 'STEEL', material: 'Brushed Steel', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'steel', frameMat: 'steel_ms', glassMat: 'clear' } },
    { id: 'win_glass', name: 'Frameless Glass Window', badge: 'GLASS', material: 'Tempered Glass', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'glass', frameMat: 'glass_clear', glassMat: 'clear' } },
    { id: 'win_frp', name: 'FRP Window', badge: 'FRP', material: 'Fiber Reinforced Plastic', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'frp', frameMat: 'upvc_white', glassMat: 'clear' } },
    { id: 'win_composite', name: 'Composite Window', badge: 'COMPOSITE', material: 'Composite Panel', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'composite', frameMat: 'alum_black', glassMat: 'clear' } },
]);
