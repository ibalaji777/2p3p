...
const dir = 'd:\\business\\android-planner\\public\\models\\sofas';
    ...
    if (chunk0Type === 'JSON') {
        ...
        try {
            ...
            results[file] = {
                author,
                license,
                title: asset.extras && asset.extras.title ? asset.extras.title : 'Unknown'
            };
        } catch (e) {
            results[file] = { error: 'Failed to parse JSON' };
        }
    }
