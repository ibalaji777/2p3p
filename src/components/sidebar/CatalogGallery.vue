...
const doorCatalog = ref([
    ...
    { id: 'door_steel', name: 'Steel Door', badge: 'STEEL', material: 'Light Smooth Steel', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'steel', materials: { leaf: { id: 'metal_light_steel' }, frame: { id: 'metal_light_steel' } } } },
