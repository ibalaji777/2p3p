...
const staircaseCatalog = ref([
    ...
    { id: 'stair_straight_side', name: 'Side Stringers', badge: 'MODERN', material: 'White Painted', specs: '1000 × 3000 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_straight', shape: 'straight', width: 100, length: 330, height: 300, totalSteps: 12, stepDepth: 28, stepHeight: 17.5, stringerType: 'side', primaryColor: '#ffffff', materials: { treads: { id: 'upvc_white' }, stringers: { id: 'upvc_white' }, risers: { id: 'upvc_white' }, landings: { id: 'upvc_white' } } } },
    { id: 'stair_L_concrete', name: 'L-Shape (Concrete)', badge: 'SOLID', material: 'Cast Concrete', specs: '2000 × 2000 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_L', shape: 'L', width: 100, flight1Steps: 8, flight2Steps: 7, height: 300, stepDepth: 28, stepHeight: 17.5, stringerType: 'solid', primaryColor: '#999999', materials: { treads: { id: 'stone_basalt_lava' }, stringers: { id: 'stone_basalt_lava' }, risers: { id: 'stone_basalt_lava' }, landings: { id: 'stone_basalt_lava' } } } },
    { id: 'stair_L_mono', name: 'L-Shape (Mono)', badge: 'STEEL', material: 'Industrial Steel', specs: '2000 × 2000 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_L', shape: 'L', width: 100, flight1Steps: 8, flight2Steps: 7, height: 300, stepDepth: 28, stepHeight: 17.5, stringerType: 'mono', primaryColor: '#444444', materials: { treads: { id: 'metal_gunmetal_black' }, stringers: { id: 'metal_gunmetal_black' }, risers: { id: 'metal_gunmetal_black' }, landings: { id: 'metal_gunmetal_black' } } } },
