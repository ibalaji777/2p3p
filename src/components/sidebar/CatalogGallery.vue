...
const staircaseCatalog = ref([
    { id: 'stair_straight_solid', name: 'Solid Base (Wood)', badge: 'WOOD', material: 'Teak Wood Steps', specs: '1000 × 3000 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_straight', shape: 'straight', width: 40, length: 120, height: 120, steps: 10, stringerType: 'solid', primaryColor: '#8b5a2b', materials: { treads: { id: 'wood_golden_teak' }, stringers: { id: 'wood_golden_teak' }, risers: { id: 'wood_white_oak' }, landings: { id: 'wood_golden_teak' } } } },
    { id: 'stair_straight_mono', name: 'Mono Stringer (Steel)', badge: 'STEEL', material: 'Black Powder Steel', specs: '1000 × 3000 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_straight', shape: 'straight', width: 40, length: 120, height: 120, steps: 10, stringerType: 'mono', primaryColor: '#333333', materials: { treads: { id: 'metal_gunmetal_black' }, stringers: { id: 'metal_gunmetal_black' }, risers: { id: 'metal_gunmetal_black' }, landings: { id: 'metal_gunmetal_black' } } } },
    { id: 'stair_straight_double', name: 'Double Stringer', badge: 'CLASSIC', material: 'Oak & Steel', specs: '1000 × 3000 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_straight', shape: 'straight', width: 40, length: 120, height: 120, steps: 10, stringerType: 'double', primaryColor: '#a67b5b', materials: { treads: { id: 'wood_white_oak' }, stringers: { id: 'metal_gunmetal_black' }, risers: { id: 'wood_white_oak' }, landings: { id: 'wood_white_oak' } } } },
    { id: 'stair_straight_side', name: 'Side Stringers', badge: 'MODERN', material: 'White Painted', specs: '1000 × 3000 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_straight', shape: 'straight', width: 40, length: 120, height: 120, steps: 10, stringerType: 'side', primaryColor: '#ffffff', materials: { treads: { id: 'upvc_white' }, stringers: { id: 'upvc_white' }, risers: { id: 'upvc_white' }, landings: { id: 'upvc_white' } } } },
    { id: 'stair_L_concrete', name: 'L-Shape (Concrete)', badge: 'SOLID', material: 'Cast Concrete', specs: '2000 × 2000 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_L', shape: 'L', width: 40, length1: 80, length2: 80, height: 120, stringerType: 'solid', primaryColor: '#999999', materials: { treads: { id: 'stone_basalt_lava' }, stringers: { id: 'stone_basalt_lava' }, risers: { id: 'stone_basalt_lava' }, landings: { id: 'stone_basalt_lava' } } } },
    { id: 'stair_L_mono', name: 'L-Shape (Mono)', badge: 'STEEL', material: 'Industrial Steel', specs: '2000 × 2000 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_L', shape: 'L', width: 40, length1: 80, length2: 80, height: 120, stringerType: 'mono', primaryColor: '#444444', materials: { treads: { id: 'metal_gunmetal_black' }, stringers: { id: 'metal_gunmetal_black' }, risers: { id: 'metal_gunmetal_black' }, landings: { id: 'metal_gunmetal_black' } } } },
    { id: 'stair_U_wood', name: 'U-Shape (Box)', badge: 'WOOD', material: 'Solid Oak', specs: '1500 × 1500 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_U', shape: 'U', width: 40, length1: 60, length2: 60, width2: 40, height: 120, stringerType: 'box', primaryColor: '#8b5a2b', materials: { treads: { id: 'wood_dark_walnut' }, stringers: { id: 'wood_dark_walnut' }, risers: { id: 'wood_dark_walnut' }, landings: { id: 'wood_dark_walnut' } } } },
    { id: 'stair_T_marble', name: 'T-Shape (Marble)', badge: 'LUXURY', material: 'Nero Marquina Black', specs: '2000 × 2000 mm', image: '', toolId: 'staircase', params: { type: 'stair_v5_T', shape: 'T', width: 40, length1: 60, length2: 80, height: 120, stringerType: 'solid', primaryColor: '#222222', materials: { treads: { id: 'marble_nero_marquina' }, stringers: { id: 'marble_nero_marquina' }, risers: { id: 'marble_nero_marquina' }, landings: { id: 'marble_nero_marquina' } } } },
]);
