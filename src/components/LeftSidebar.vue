            ...
            <div class="submenu-content">
                <template v-for="(tool, idx) in activeCategoryObj.tools" :key="tool.id || idx">
                    ...
                    <button v-else
                        ...
                        :class="{ active: isToolActive(tool.id) && !tool.action, 'has-accordion': ['door', 'window', 'sunshade', 'jali_panel', 'staircase', 'roof', 'dormer', 'molding', 'elevation_fascia', 'wall_catalog', 'shape_catalog', 'adv_opening_catalog', 'railing_catalog', 'furniture_catalog', 'kitchen_catalog'].includes(tool.id) }"
                        @click="$emit('tool-click', tool)"
                        style="display: flex; align-items: center; justify-content: space-between;">
                        <span>{{ tool.name }}</span>
                        <svg v-if="['door', 'window', 'sunshade', 'jali_panel', 'staircase', 'roof', 'dormer', 'molding', 'elevation_fascia', 'wall_catalog', 'shape_catalog', 'adv_opening_catalog', 'railing_catalog', 'furniture_catalog', 'kitchen_catalog'].includes(tool.id)" 
                             class="chevron" 
                    ...
                    <div v-if="['door', 'window', 'sunshade', 'jali_panel', 'staircase', 'roof', 'dormer', 'molding', 'elevation_fascia', 'wall_catalog', 'shape_catalog', 'adv_opening_catalog', 'railing_catalog', 'furniture_catalog', 'kitchen_catalog'].includes(tool.id) && isToolActive(tool.id)" class="catalog-accordion">
