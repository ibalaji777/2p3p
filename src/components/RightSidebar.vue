        ...
        <div class="tab-body" v-show="activeRightTab === 'properties'">
            ...
            <div v-else-if="selectedType === 'shape'">
                <div v-if="!selectedEntity.params.isEditingMaterials">
                    ...
                    <div class="control-group"><label>3D Height</label><div class="input-wrap"><input type="range" v-model.number="selectedEntity.params.height3D" min="10" max="1000" @input="$emit('sync-engine')"><input type="number" v-model.number="selectedEntity.params.height3D" @input="$emit('sync-engine')"></div></div>
                    <div v-if="selectedEntity.type === 'shape_rect'">
                        ...
                        <div class="control-group"><label>Height</label><div class="input-wrap"><input type="range" v-model.number="selectedEntity.params.height" min="10" max="1000" @input="$emit('sync-engine')"><input type="number" v-model.number="selectedEntity.params.height" @input="$emit('sync-engine')"></div></div>
                    </div>
