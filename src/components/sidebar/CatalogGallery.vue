...
const doorCatalog = ref([
    ...
    { id: 'door_wpc', name: 'WPC Door', badge: 'WPC', material: 'Wood Plastic Composite', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'wpc', materials: { leaf: { id: 'wood_golden_teak' }, frame: { id: 'wood_golden_teak' } } } },
    { id: 'door_upvc', name: 'uPVC Door', badge: 'uPVC', material: 'Rigid uPVC', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'upvc', materials: { leaf: { id: 'upvc_white' }, frame: { id: 'upvc_white' } } } },
    { id: 'door_pvc', name: 'PVC Door', badge: 'PVC', material: 'Matte White PVC', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'pvc', materials: { leaf: { id: 'upvc_white' }, frame: { id: 'upvc_white' } } } },
    { id: 'door_aluminium', name: 'Aluminium Door', badge: 'ALUMINIUM', material: 'Silver Aluminium', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'aluminium', materials: { leaf: { id: 'alum_silver' }, frame: { id: 'alum_silver' } } } },
    { id: 'door_steel', name: 'Steel Door', badge: 'STEEL', material: 'Brushed Steel', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'steel', materials: { leaf: { id: 'steel_ms' }, frame: { id: 'steel_ms' } } } },
    ...
    { id: 'door_frp', name: 'FRP Door', badge: 'FRP', material: 'Fiber Reinforced Plastic', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'frp', materials: { leaf: { id: 'upvc_white' }, frame: { id: 'upvc_white' } } } },
    { id: 'door_composite', name: 'Composite Door', badge: 'COMPOSITE', material: 'Composite Panel', specs: '900 × 2100 mm', category: 'single', image: '', params: { doorType: 'single', doorStyle: 'flat', width: 40, materialCategory: 'composite', materials: { leaf: { id: 'alum_black' }, frame: { id: 'alum_black' } } } },
]);

const windowCatalog = ref([
    { id: 'sliding_std', name: 'Standard Sliding', badge: 'POPULAR', material: 'Aluminium Frame', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'aluminium', materials: { frame: { id: 'alum_silver' }, glass: { id: 'clear' } } } },
    { id: 'casement_std', name: 'Casement Window', badge: 'CLASSIC', material: 'White Vinyl', specs: '900 × 1200 mm', category: 'casement', image: '', params: { windowType: 'casement_std', width: 40, materialCategory: 'upvc', materials: { frame: { id: 'upvc_white' }, glass: { id: 'clear' } } } },
    { id: 'fixed_elevation', name: 'Fixed Picture Window', badge: 'MODERN', material: 'Clear Glass', specs: '1800 × 1500 mm', category: 'fixed', image: '', params: { windowType: 'fixed_elevation', width: 80, materialCategory: 'aluminium', materials: { frame: { id: 'alum_silver' }, glass: { id: 'clear' } } } },
    { id: 'bay_box', name: 'Bay Window', badge: 'ARCHITECTURAL', material: 'Solid Wood Frame', specs: '1800 × 1500 mm', category: 'bay', image: '', params: { windowType: 'bay_box', width: 80, materialCategory: 'wood', materials: { frame: { id: 'wood_golden_teak' }, glass: { id: 'clear' } } } },
    { id: 'panoramic_slider', name: 'Panoramic Slider', badge: 'PREMIUM', material: 'Slim Steel Frame', specs: '2400 × 1800 mm', category: 'sliding', image: '', params: { windowType: 'panoramic_slider', width: 120, materialCategory: 'steel', materials: { frame: { id: 'steel_ms' }, glass: { id: 'clear' } } } },
    { id: 'win_wood', name: 'Wood Window', badge: 'WOOD', material: 'Solid Teak Wood', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'wood', materials: { frame: { id: 'wood_golden_teak' }, glass: { id: 'clear' } } } },
    { id: 'win_wpc', name: 'WPC Window', badge: 'WPC', material: 'Wood Plastic Composite', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'wpc', materials: { frame: { id: 'wood_golden_teak' }, glass: { id: 'clear' } } } },
    { id: 'win_upvc', name: 'uPVC Window', badge: 'uPVC', material: 'Rigid uPVC', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'upvc', materials: { frame: { id: 'upvc_white' }, glass: { id: 'clear' } } } },
    { id: 'win_pvc', name: 'PVC Window', badge: 'PVC', material: 'Matte White PVC', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'pvc', materials: { frame: { id: 'upvc_white' }, glass: { id: 'clear' } } } },
    { id: 'win_aluminium', name: 'Aluminium Window', badge: 'ALUMINIUM', material: 'Silver Aluminium', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'aluminium', materials: { frame: { id: 'alum_silver' }, glass: { id: 'clear' } } } },
    { id: 'win_steel', name: 'Steel Window', badge: 'STEEL', material: 'Brushed Steel', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'steel', materials: { frame: { id: 'steel_ms' }, glass: { id: 'clear' } } } },
    { id: 'win_glass', name: 'Frameless Glass Window', badge: 'GLASS', material: 'Tempered Glass', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'glass', materials: { frame: { id: 'glass_clear' }, glass: { id: 'clear' } } } },
    { id: 'win_frp', name: 'FRP Window', badge: 'FRP', material: 'Fiber Reinforced Plastic', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'frp', materials: { frame: { id: 'upvc_white' }, glass: { id: 'clear' } } } },
    { id: 'win_composite', name: 'Composite Window', badge: 'COMPOSITE', material: 'Composite Panel', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'composite', materials: { frame: { id: 'alum_black' }, glass: { id: 'clear' } } } },
]);
