...
const windowCatalog = ref([
    ...
    { id: 'panoramic_slider', name: 'Panoramic Slider', badge: 'PREMIUM', material: 'Slim Steel Frame', specs: '2400 × 1800 mm', category: 'sliding', image: '', params: { windowType: 'panoramic_slider', width: 120, materialCategory: 'steel', materials: { frame: { id: 'steel_ms' }, leaf: { id: 'steel_ms' }, glass: { id: 'clear' }, hardware: { id: 'metal_gunmetal_black' }, seal: { id: 'seal_black' } , grille: { id: 'metal_matte_black' } } } },
    ...
    { id: 'win_steel', name: 'Steel Window', badge: 'STEEL', material: 'Brushed Steel', specs: '1200 × 1200 mm', category: 'sliding', image: '', params: { windowType: 'sliding_std', width: 60, materialCategory: 'steel', materials: { frame: { id: 'steel_ms' }, leaf: { id: 'steel_ms' }, glass: { id: 'clear' }, hardware: { id: 'metal_gunmetal_black' }, seal: { id: 'seal_black' } , grille: { id: 'metal_matte_black' } } } },
